...
class _ApiService implements ApiService {
  ...
  @override
  Future<List<LaunchpadModel>> getLaunchpads() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<LaunchesPaginatedModel> getLaunches(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<LaunchesPaginatedModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = LaunchesPaginatedModel.fromJson(_result.data!);
    return value;
  }

  @override
  Future<CoresQueryModel> getCores(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CoresQueryModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CoresQueryModel.fromJson(_result.data!);
    return value;
  }
